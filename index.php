...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/Bossam.jpg">
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 380.721 380.721">
                                <g fill="#FFF">
                                    <path d="<i class="fa fa-inr" style="font-size:36px"></i>" /> </g>
                            </svg>
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo ' <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="images/dishes/'.$r['img'].'"></div>
                                                <div class="content">
                                                    <h5><a href="dishes.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price"><i class="fa fa-inr" aria-hidden="true"></i>'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>name: Glory_12029 TYBCA</p>
                                    <p> St. Mira's Girls College,Pune</p>
                                    <h5>Guidance By: Monika Rajguru</a></h5> </div>
